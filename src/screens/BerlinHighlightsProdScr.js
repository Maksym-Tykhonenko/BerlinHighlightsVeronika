...
const BerlinHighlightsProdScr = ({navigation, route}) => {
  ...
  const INITIAL_URL = `https://fabulous-ceremonial-festivity.space/`;
  const URL_IDENTIFAIRE = `iuJYBsDS`;
      ...
      <View
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/upgrDiz/arrow77.png')}
          />
        </TouchableOpacity>
        ...
        <TouchableOpacity
          ...
          <Image
            ...
            source={require('../assets/upgrDiz/redo77.png')}
          />
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
export default BerlinHighlightsProdScr;
